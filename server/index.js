...
app.get('/RecipesByPantry', (req, res) => {
  // request to DB for pantry ingredients
  // let pantryList = '';
  //   for (var i = 0; i < pantry.length; i++) {
  //     pantryList += pantry.ingredient;
  //   }

  // axios.get('APIURL', pantryList)
  //   .then((success) => {
  //     res.send(success);
  //   })
  //   .catch((err) => {
  ...
  res.send(sampleRecipes);
});

app.get('/Recipe/:id', (req, res) => {
  console.log(req.params.id);
  const sampleRecipeById = {
    id: 716429,
